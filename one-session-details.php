      ...
      <div class="page-title-wrapper">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-10">
              <h1 class="page-title">1:1 session details</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card12 our-team profile">
                        ...
                        <br/>
                        <p class="name">When creating a personal portfolio website...</p>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card12 our-team profile">
                      <a href="one-session-details.php" style= "float:right;margin-right:20px" class="view-details">View profile</a>
                
                      <h2>Entertainment + 3</h2>                       
                      <br/>
                      ...
                      <div class="row left_align">
                        ...
                        <div class="col-md-9 col-lg-9 col-sm-9 col-12">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-12">
                            <button class="consulting">
                            <a href="#" class="color-anchor" >Management consulting</a>
                            </button>
                        </div>
                        </div>
                      </div>                          
                      ...
                      <hr/>
                          <div class="row left_align margin-top-bottom">
                              ...
                              <div class="col-md-5 col-12 col-lg-5 col-sm-5">
                                  <button class="session-start-completed">
                                  <a href="#" class="color-anchor" > Completed</a>
                                  </button>
                              </div>
                          ...
                          <div class="row margin-top-bottom"> -->
                            ...
                            <div class="col-md-12 col-12 col-lg-12 col-sm-12">
                                ...
                                <a href="#" class="color-anchor" > Rate Now</a>
                                </button>
                            </div>
